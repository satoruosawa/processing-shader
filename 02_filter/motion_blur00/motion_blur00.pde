...
void draw() {
  ...
  GRAPHICS[REF_GRAPHICS].beginDraw();
  GRAPHICS[REF_GRAPHICS].fill(0);
  GRAPHICS[REF_GRAPHICS].noStroke();
  GRAPHICS[REF_GRAPHICS].rectMode(CENTER);
  GRAPHICS[REF_GRAPHICS].rect(mouseX, mouseY, 100, 100);
  GRAPHICS[REF_GRAPHICS].endDraw();
  ...
  GRAPHICS[TARGET_GRAPHICS].rectMode(CORNER);
